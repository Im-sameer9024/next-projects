...
export const DeleteChapter = asyncHandler(
  async (req: Request, res: Response) => {
    ...
    if (chapter.muxData && chapter.muxData?.assetId) {
      await mux.video.assets.delete(chapter.muxData?.assetId as string);
...
export const PublishChapter = asyncHandler(
  async (req: Request, res: Response) => {
    const { chapterId, courseId } = req.body;
...
export const UnPublishChapter = asyncHandler(
  async (req: Request, res: Response) => {
    const { chapterId, courseId } = req.body;
...
export const UploadChapterVideo = asyncHandler(
  async (req: Request, res: Response) => {
...
export const DeleteChapterVideo = asyncHandler(
  async (req: Request, res: Response) => {
    const { chapterId } = req.body;
...
export const SaveChapterVideo = asyncHandler(
  async (req: Request, res: Response) => {
